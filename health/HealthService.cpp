 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.xiaomi_msm8998"
...
using ::device::xiaomi::msm8998::health::CycleCountBackupRestore;
using ::device::xiaomi::msm8998::health::LearnedCapacityBackupRestore;
